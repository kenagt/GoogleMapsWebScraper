        ...
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          <div className="px-4 py-6 sm:px-0">
            ...
            <div className="grid grid-cols-1 gap-8">
              ...
              <div>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Scraping jobs</h2>
                <ResultsTable onJobSelect={setSelectedJobId} />
              </div>

              <div>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">
                  {selectedJobId ? `Results for job ID: ${selectedJobId}` : 'Scraping Results Data Table'}
                </h2>
